                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-2 items-center">
                                    ...
                                    ${p.age ? `<span class="text-[9px] font-bold text-gray-400 uppercase tracking-widest bg-gray-100 px-2 py-0.5 rounded-full">Age: ${p.age}</span>` : ''}
                                </div>
                            </div>
                        </div>
